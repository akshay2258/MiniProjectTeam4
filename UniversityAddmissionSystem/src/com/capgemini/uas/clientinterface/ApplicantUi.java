package com.capgemini.uas.clientinterface;
...
public class ApplicantUi {
	...
	public static void main(String[] args) {
		...
		String fullName,dob,highestQualification,doi;
	   ...
	   break;
		...
		case 3:
			...
			applicationId = sc.nextInt();
				...
				DateTimeFormatter formatDoi = DateTimeFormatter.ofPattern("yyyy-MM-dd");
				LocalDate checkDoi = LocalDate.parse("2012-12-12",formatDoi);
